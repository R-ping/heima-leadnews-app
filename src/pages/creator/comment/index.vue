        ...
        <el-table
          ...
          <el-table-column
            ...
            <template slot-scope="scope">
              <el-tag :type="scope.row.comment_status ? 'success' : 'danger'" size="small">
...
<script>
import { closeOrOpenComment, getCommentList } from  '@/apis/creator/comment'
import { searchArticle } from  '@/apis/creator/content'
export default {
  name: 'ContentManage',
  data() {
    return {
